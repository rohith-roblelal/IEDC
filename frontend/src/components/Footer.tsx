    ...
    <footer className="bg-[#0A0A0F] rounded-t-[28px] px-6 pt-16 pb-10 mt-10">
      <div className="max-w-[700px] mx-auto text-center">
        ...
        <div className="mt-10 flex justify-center gap-4">
          <Link href="https://www.facebook.com/people/Iedc-Snmimt/61555494891838/?rdid=296gKCa1XzwvlzRB&share_url=https%3A%2F%2Fwww.facebook.com%2Fshare%2F1bCU5fhpQ5%2F" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center text-white hover:bg-white/20 transition-colors">
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></svg>
          </Link>
          <Link href="https://www.instagram.com/iedc.snm?igsh=NTEzajB5d2w5cWs4" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center text-white hover:bg-white/20 transition-colors">
          ...
          <Link href="https://www.linkedin.com/in/iedcsnmimt/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center text-white hover:bg-white/20 transition-colors">
